...
##### Male With Asthma
![Male With Asthma](male_with_asthma.png)
![Relationship between Fire Smoke Estimate and Age-Standardized Mortality Rate From Asthma (Male)](Relationship_between_Fire_Smoke_Estimate_and_Age_Standardized_Mortality_Rate_From Asthma_Male.png)

##### Female With Asthma
![Female With Asthma](female_with_asthma.png)
![Relationship between Fire Smoke Estimate and Age-Standardized Mortality Rate From Asthma (Female)](Relationship_between_Fire_Smoke_Estimate_and_Age_Standardized_Mortality_Rate_From Asthma_Female.png)
